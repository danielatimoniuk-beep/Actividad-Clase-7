describe('ingreso', () => {
  ...
  it('registrarse', () => {
    ...
    cy.get('[data-cy="input-dni"]').type('77777777');
    ...
    cy.get('[data-cy="input-email"]').type('daniela74@gmail.com');
    cy.get('[data-cy="input-confirmar-email"]').type('daniela74@gmail.com');
